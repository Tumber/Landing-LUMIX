var elems = document.getElementsByClassName('bg-amin');
...
function showMenu(){
	if( getCoords(elems[0]).top + elems[0].offsetHeight <= window.pageYOffset){
		document.querySelector(".navbar-header").style.top = '0px';
	} else {
		document.querySelector(".navbar-header").style.top = '-60px';
	}
}
